...
const Verififcation = require("../features/onboarding/route");
const Notification = require("../features/notifications/route");
...
router.use("/verification", authenticate(), Verififcation);
